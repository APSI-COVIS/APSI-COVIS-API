...
public interface CountryCovidInformationResource {
    ...
    @RequestMapping(value = "/{country-slug}/epidemy-info", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/{country-slug}/epidemy-forecast", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/{country-slug}/population", method = RequestMethod.GET)
